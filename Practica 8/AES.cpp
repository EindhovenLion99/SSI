...
{ // rotamos 2 fila un byte,3 fila dos bytes y 4
  // fila tres bytes
  unsigned char copia;
...
void AES::mixColumns(unsigned char (*r)[4])
{                     // cada columna se multiplica por una matriz dada
